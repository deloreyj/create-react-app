 ...
 * Allow the websocket connection to point to a different endpoint than the current window location
 * */
var protocol = window.location.protocol;
var hostname = process.env.WDS_SOCKET_HOST || window.location.hostname;
var port = process.env.WDS_SOCKET_PORT || window.location.port;
